...
export default function Register() {
  ...
  return (
    <div style={{ display: 'flex', justifyContent: 'center', paddingTop: '60px', padding: '60px 16px 40px' }}>
      <div style={{ width: '100%', maxWidth: '420px' }}>
        <h1 style={{ fontSize: '26px', fontWeight: 700, marginBottom: '6px', textAlign: 'center' }}>Create account</h1>
        <p style={{ color: 'var(--text-muted)', fontSize: '14px', textAlign: 'center', marginBottom: '28px' }}>
          Join Pilcrow and start sharing
        </p>
